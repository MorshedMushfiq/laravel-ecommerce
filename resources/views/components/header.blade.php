                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="header__top__right">
                            <div class="header__top__links">
                                @if(Session::has("id"))
                                <a href="{{URL::to('/logout_User')}}">Log out</a>
                                @else
            ...
            <div class="row">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="{{URL::to('/shop')}}">Shop Details</a></li>
                                    ...
                                    <li><a href="{{URL::to('/blog')}}">Blog Details</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a href="#" class="search-switch"><img src="{{URL::asset('img/icon/search.png')}}" alt=""></a>
                        <a href="#"><img src="{{URL::asset('img/icon/heart.png')}}" alt=""></a>
                        <a href="{{URL::to('/shopping_cart')}}"><img src="{{URL::asset('img/icon/cart.png')}}" alt=""> <span>0</span></a>
                        <div class="price">$0.00</div>
                    </div>
                </div>
            </div>

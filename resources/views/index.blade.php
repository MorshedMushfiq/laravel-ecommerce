...
<x-header title="Home | Fashion E-commerce" description="Home Page of fashion ecommerce" keywords='home ecommerce multirole client'/>
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{URL::asset('uploads/products/' . $items->image)}}" alt="{{$items->keywords}}">
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="{{route('single.shop', $items->id)}}"><img src="img/icon/search.png" alt=""></a></li>
                            </ul>
                        </div>
